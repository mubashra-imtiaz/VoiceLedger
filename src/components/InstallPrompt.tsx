...
export function InstallPrompt() {
    ...
    return (
        <div className="fixed bottom-4 left-4 right-4 z-50 rounded-xl bg-slate-900 p-4 text-white shadow-2xl flex items-center justify-between border border-slate-700">
            <div>
